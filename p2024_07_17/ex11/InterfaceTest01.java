...
// 1.인터페이스를 상속 받을때는 implements 로 상속 받아야 한다.
// 2.인터페이스를 상속 받으면, 부모 인터페이스 안의 추상 메소드를 자식 클래스에서
//   반드시 메소드 재정의(Method Overriding) 를 해야한다.
class Hello implements IHello{
	@Override
	public void sayHello(String name) {	 // 메소드 재정의	
		System.out.println(name+ "씨 안녕 하세요.");
	}	
}
public class InterfaceTest01 {
	public static void main(String[] args) {
		// 인터페이스는 자체적으로 객체 생성를 할 수 없다.
//		IHello ih = new IHello();   // 에러발생
